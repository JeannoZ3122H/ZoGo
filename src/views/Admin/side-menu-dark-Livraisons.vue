                ...
                <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
                    ...
                    <div class="intro-y box bg-primary p-5 mt-6">
                        ...
                        <div class="border-t border-white/10 dark:border-darkmode-400 mt-6 pt-6 text-white">
                            ...
                            <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md"> <i class="w-4 h-4 mr-2" data-lucide="star"></i> Marked </a>
                ...
                <div class="col-span-12 lg:col-span-9 2xl:col-span-10">
                    ...
                    <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                        <div class="w-full sm:w-auto relative mr-auto mt-3 sm:mt-0">
                            <img alt="Midone - HTML Admin Template" class="w-4 h-4 absolute my-auto inset-y-0 ml-3 left-0 z-10 text-slate-500" src="../../assets/images/searching.png" />
