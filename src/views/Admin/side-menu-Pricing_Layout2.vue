            ...
            <div class="intro-y flex justify-center mt-6">
                <ul class=" pricing-tabs nav nav-pills w-auto box rounded-full mx-auto overflow-hidden " role="tablist" >
                    <li id="layout-1-monthly-fees-tab" class="nav-item flex-1" role="presentation">
                        <button class="nav-link w-32 lg:w-40 py-2 lg:py-3 active" data-tw-toggle="pill" data-tw-target="#layout-1-monthly-fees" type="button" role="tab" aria-controls="layout-1-monthly-fees" aria-selected="true" > Monthly Fees </button>
                    </li>
                    <li id="layout-1-annual-fees-tab" class="nav-item flex-1" role="presentation">
                        <button class="nav-link w-32 lg:w-40 py-2 lg:py-3" data-tw-toggle="pill" data-tw-target="#layout-1-annual-fees" type="button" role="tab" aria-controls="layout-1-annual-fees" aria-selected="false" > Annual Fees </button>
                    </li>
                </ul>
            </div>
            <!-- END: Pricing Tab -->
                ...
                <div class="tab-content">
                    <div id="layout-1-monthly-fees" class="tab-pane flex flex-col lg:flex-row active" role="tabpanel" aria-labelledby="layout-1-monthly-fees-tab">
                        ...
                        <div class="intro-y flex-1 box py-16 lg:ml-5">
                            ...
                            <div class="text-slate-500 px-10 text-center mx-auto mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
                            <div class="flex justify-center">
                                <div class="relative text-5xl font-semibold mt-8 mx-auto"> <span class="absolute text-2xl top-0 left-0 -ml-4">$</span> 120 </div>
                            </div>
                            <button type="button" class="btn btn-rounded-primary py-3 px-4 block mx-auto mt-8">PURCHASE NOW</button>
                        </div>
                    </div>
                    <div id="layout-1-annual-fees" class="tab-pane flex flex-col lg:flex-row" role="tabpanel" aria-labelledby="layout-1-annual-fees-tab">
                        ...
                        <div class="intro-y flex-1 box py-16 lg:ml-5 mb-5 lg:mb-0">
                            ...
                            <div class="text-slate-500 px-10 text-center mx-auto mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
                            <div class="flex justify-center">
                                <div class="relative text-5xl font-semibold mt-8 mx-auto"> <span class="absolute text-2xl top-0 left-0 -ml-4">$</span> 40 </div>
                            </div>
                            <button type="button" class="btn btn-rounded-primary py-3 px-4 block mx-auto mt-8">PURCHASE NOW</button>
                        </div>
                        <div class="intro-y flex-1 box py-16 lg:ml-5">
                            ...
                            <div class="text-slate-500 px-10 text-center mx-auto mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
                            <div class="flex justify-center">
                                <div class="relative text-5xl font-semibold mt-8 mx-auto"> <span class="absolute text-2xl top-0 left-0 -ml-4">$</span> 90 </div>
                            </div>
                            <button type="button" class="btn btn-rounded-primary py-3 px-4 block mx-auto mt-8">PURCHASE NOW</button>
                        </div>
                    </div>
                ...
                <div class="intro-y flex justify-center mt-6">
                    <ul class=" pricing-tabs nav nav-pills w-auto box rounded-full mx-auto overflow-hidden " role="tablist" >
                        <li id="layout-2-monthly-fees-tab" class="nav-item flex-1" role="presentation">
                            <button class="nav-link w-32 lg:w-40 py-2 lg:py-3 active" data-tw-toggle="pill" data-tw-target="#layout-2-monthly-fees" type="button" role="tab" aria-controls="layout-2-monthly-fees" aria-selected="true" > Monthly Fees </button>
                        </li>
                        <li id="layout-2-annual-fees-tab" class="nav-item flex-1" role="presentation">
                            <button class="nav-link w-32 lg:w-40 py-2 lg:py-3" data-tw-toggle="pill" data-tw-target="#layout-2-annual-fees" type="button" role="tab" aria-controls="layout-2-annual-fees" aria-selected="false" > Annual Fees </button>
                        </li>
                    </ul>
                </div>
                <!-- END: Pricing Tab -->
                    ...
                    <div class="tab-content">
                        ...
                        <div id="layout-2-annual-fees" class="tab-pane flex flex-col lg:flex-row" role="tabpanel" aria-labelledby="layout-2-annual-fees-tab">
                            ...
                            <div class="intro-y flex-1 py-16">
                                ...
                                <div class="text-slate-500 px-10 text-center mx-auto mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
                                <div class="flex justify-center">
                                    <div class="relative text-5xl font-semibold mt-8 mx-auto"> <span class="absolute text-2xl top-0 left-0 -ml-4">$</span> 210 </div>
                                </div>
                                <button type="button" class="btn btn-rounded-primary py-3 px-4 block mx-auto mt-8">PURCHASE NOW</button>
                            </div>
                        </div>
