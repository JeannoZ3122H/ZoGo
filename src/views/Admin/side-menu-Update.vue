                                    ...
                                    <div class="grid grid-cols-12 gap-x-5">
                                        <div class="col-span-12 2xl:col-span-6">
                                            <div>
                                                ...
                                                <input id="update-profile-form-1" type="text" class="form-control" placeholder="Input text" value="Brad Pitt" disabled>
                                            </div>
                                            <div class="mt-3">
                                ...
                                <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                                    <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                            <img class="rounded-md" alt="Midone - HTML Admin Template" src="dist/images/profile-7.jpg">
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 xl:col-span-6">
                                    <div>
                                        ...
                                        <input id="update-profile-form-6" type="text" class="form-control" placeholder="Input text" value="bradpitt@left4code.com" disabled>
                                    </div>
                                    <div class="mt-3">
                                        <label for="update-profile-form-7" class="form-label">Name</label>
                                        <input id="update-profile-form-7" type="text" class="form-control" placeholder="Input text" value="Brad Pitt" disabled>
                                    </div>
                                    <div class="mt-3">
